...
namespace PyConsumerApp.ViewModels.Products
{
    static class BitmapExtensions
    {
        ...
        public static SKBitmap LoadBitmapStream(Stream stream)
        {
            return SKBitmap.Decode(stream);
        }

        public static SKBitmap LoadImageFromInternet(string url)
        {
            var result = Task.Run(async () => await LoadImageFromInternetAsync(url)).Result;
            return result;
        }
        public async static Task<SKBitmap> LoadImageFromInternetAsync(string url)
        {
